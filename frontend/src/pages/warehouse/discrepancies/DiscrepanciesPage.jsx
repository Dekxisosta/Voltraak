...
import { Card, Table, StatusBadge, Button, Input, Modal, SearchBar, LoadingSpinner } from '@/components/common'
import { PageHeader } from '@/components/layout'
import { useNotifications } from '@/hooks/useNotifications'
import { fetchData } from '@/shared/services/dataSource'
import { mockDiscrepancies } from './mocks'
  ...
  const loadDiscrepancies = async () => {
    try {
      ...
      const result = await fetchData(
        () => mockDiscrepancies,
        () => null // TODO: inventoryApi.getDiscrepancyReports()
      )
