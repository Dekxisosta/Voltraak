...
import { PageHeader, Card, Table, StatusBadge, Button, Input, Select, SearchBar, LoadingSpinner } from '@/components/common'
import { useNotifications } from '@/hooks/useNotifications'
import type { TableColumn, StockTransaction } from '@/types'

interface StockInOutPageData {
...
export default function StockInOutPage() {
  const [data, setData] = useState<StockInOutPageData>({
    transactions: [],
    loading: true
  })
  ...
  const [transactionForm, setTransactionForm] = useState<StockTransactionForm>({
    type: 'stock_in',
    product_id: '',
    quantity: 0,
    reference_number: '',
  ...
  const loadTransactions = async () => {
    try {
      ...
      const mockData: StockTransaction[] = [
        {
          id: 1,
          ...
          notes: 'Received from ABC Electronics',
          created_at: '2024-08-12T10:30:00Z'
        },
        {
          id: 2,
          transaction_number: 'TXN-OUT-002',
          type: 'stock_out',
          ...
          notes: 'FEFO compliant pick',
          created_at: '2024-08-12T14:15:00Z'
        },
        {
          id: 3,
          transaction_number: 'TXN-OUT-003',
          type: 'stock_out',
          ...
          performed_by: 'Pedro Garcia',
          notes: 'Unit damaged during inspection',
