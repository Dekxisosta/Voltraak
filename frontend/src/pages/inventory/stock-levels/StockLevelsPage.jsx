...
import { Card, Table, StatusBadge, SearchBar, LoadingSpinner } from '@/shared/components/common'
...
import { mockStockLevels } from '@/shared/mocks/inventory/stock-levels'
              ...
              {data.stockLevels
                ...
                .map(item => (
                  <div key={item.id} className="flex items-center justify-between p-4 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg">
                    <div>
                      <div className="font-medium text-red-900 dark:text-red-200">{item.product_name}</div>
