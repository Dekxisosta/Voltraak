...
export default function AuthFlowTest() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case 'success': return 'text-green-800 dark:text-green-300 bg-green-100 dark:bg-green-900/30'
      case 'error': return 'text-red-800 dark:text-red-300 bg-red-100 dark:bg-red-900/30'
      case 'skipped': return 'text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-gray-700'
      default: return 'text-yellow-800 dark:text-yellow-300 bg-yellow-100 dark:bg-yellow-900/30'
    }
  }
    ...
    <div className="max-w-6xl mx-auto p-6 bg-white dark:bg-gray-800 shadow rounded-lg">
      ...
      {currentStep && (
        <div className="mb-4 p-3 bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded">
          <p className="text-yellow-800 dark:text-yellow-300 font-medium">{currentStep}</p>
        </div>
      )}
