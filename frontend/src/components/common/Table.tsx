...
export function useTableSort(initialSort?: SortOptions) {
  const [sortOptions, setSortOptions] = React.useState<SortOptions | undefined>(initialSort)
...
export function ResponsiveTable<T extends Record<string, any>>(props: TableProps<T>) {
  return (
...
export function AdaptiveTable<T extends Record<string, any>>(props: TableProps<T>) {
  return (
    <>
      {/* Desktop table */}
